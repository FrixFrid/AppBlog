...
<div class="blog-details-section section-gap-tb-165">
    <div class="blog-details-box">
                        ...
                        <div class="default-content-style pos-relative">
                            <div class="content-meta">
                                ...
                                <div class="post-meta-2">
                                    <span class="icon-space-right"><i
                                                class="icofont-ui-user"></i>by <?= $article->getAuthor() ?></span>
                                    <span class="icon-space-right"><i
                                                class="icofont-calendar"></i><?= $article->getCreatedAt() ?></span>
                                </div>
                            </div>
                            <br>
        ...
        vouloir supprimer ce commentaire ?!`)">Supprimer</a>
                        ...
                        <div class="comment-form-area section-mt-75">
                            ...
                            <div class="comment-form-box">
                                ...
                                <form class="default-form" method="post"
                                      action="/article/<?= $article->getId() ?>/comment/insert">
                                    <div class="row mb-n6">
                                        ...
                                        <div class="col-12 mb-6">
                                            <div class="default-form-group">
                                                ...
                                                <button type="submit" class="btn btn-lg btn-outline-one">Commenter
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php } else { ?>
                        <em>Il faut être connecté pour commenter</em>
                    <?php } ?>
                </div>
            </div>
        </div>
