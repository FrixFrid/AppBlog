...
<div class="hero-section section-dark-blue-bg">
    <div class="hero-wrapper">
            ...
            <div class="row">
                <div class="col-xxl-7">
                    <div class="hero-content">
                        <h3 class="title-big">Hello ! Je suis</h3>
                        ...
                        <div class="video-link">
                            ...
                            <span class="video-text"> Study with me !</span>
                        </div>
        ...
        <div class="hero-portrait">
            <div class="image">
                <img class="img-fluid" style="width: 665px" src="/img/IFXlogo4.png" alt="">
                ...
                <div class="col-xl-6 col-xxl-6 offset-xxl-1">
                    ...
                    <div class="skill-display-wrapper">
                        ...
                        <div class="skill-progress-single-item">
                            <span class="tag">Imagination et créativité</span>
                            <div class="skill-box">
                                <div class="progress-line" data-width="85">
                        ...
                        <!-- Start Skill Progress Single Item -->
                        <div class="skill-progress-single-item">
                            <span class="tag">Capacités relationnelles</span>
                            <div class="skill-box">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 offset-md-2 offset-lg-0 offset-xl-1">
                        <div class="video-info-content">
                            <h2 class="title">Je suis Farid</h2>
