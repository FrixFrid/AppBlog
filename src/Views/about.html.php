                                ...
                                <ul class="resume-list">
                                    ...
                                    <li class="resume-tab-list-single-item">
                                        <div class="content">
                                            ...
                                            <div class="right">
                                                <h3 class="title">Webdesigner Concepteur Multimédia Tout Supports </h3>
                                                <span class="institute-name">GRETA21 - Dijon</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="resume-tab-list-single-item">
                                        <div class="content">
                                            ...
                                            <div class="right">
                                                <h3 class="title">Certifications HubSpot </h3>
                                                <span class="institute-name">Hubspot Academy - En ligne</span>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- End Resume Tab List Single Item -->
                                    ...
                                    <li class="resume-tab-list-single-item">
                                        <div class="content">
                                            ...
                                            <div class="right">
                                                <h3 class="title">Développeur Web & Web Mobile</h3>
                                                <span class="institute-name">GRETA21 - Dijon</span>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="tab-pane fade" id="experience-tab" role="tabpanel">
                                <ul class="resume-list">
                                    ...
                                    <li class="resume-tab-list-single-item">
                                        <div class="content">
                                            <div class="left">
                                                <span class="year">2018 - à ce jour</span>
                                            </div>
                                            <div class="right">
